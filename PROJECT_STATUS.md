...
- Homepage hero positioning now uses a balanced two-message split: creator referral growth on the left and creator-brand monetization on the right, separated by the existing gradient divider line.
